...
- **Foundation Finder**: Analyzes a batch of IRs and ranks them by Body score (warmth/weight). The highest Body-scoring IR makes the best base. Includes Suggested Pairings (top 3 50:50 blends) with rank/nope UI that feeds the preference learning system.
