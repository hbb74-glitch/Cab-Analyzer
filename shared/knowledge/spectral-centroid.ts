export const MIC_BASE_CENTROID_RANGES: Record<string, { min: number; max: number; description: string }> = {
  'sm57': { min: 3300, max: 4200, description: 'Classic dynamic, mid-forward, aggressive - empirically measured' },
  'r121': { min: 2700, max: 3800, description: 'Ribbon, smooth highs, big low-mid - empirically measured' },
  'r10': { min: 2700, max: 3800, description: 'Ribbon, smooth and warm - empirically measured' },
  'r92': { min: 3100, max: 4200, description: 'Ribbon, similar to R121, slightly darker - empirically measured' },
  'm160': { min: 3000, max: 3900, description: 'Hypercardioid ribbon, tighter and focused - empirically measured' },
  'md421': { min: 3300, max: 4600, description: 'Large diaphragm dynamic, punchy - empirically measured' },
  'md441': { min: 2500, max: 3700, description: 'Dynamic, very accurate (flat mode) - empirically measured' },
  'md441_presence': { min: 3100, max: 4400, description: 'MD441 with presence boost - empirically measured' },
  'm88': { min: 3100, max: 4300, description: 'Warm, great low-end punch - empirically measured' },
  'pr30': { min: 3300, max: 4600, description: 'Large diaphragm dynamic, bright presence peak, detailed highs - empirically measured' },
  'e906': { min: 3500, max: 4400, description: 'Supercardioid (flat mode) - empirically measured' },
  'e906_presence': { min: 3600, max: 4600, description: 'e906 with presence boost - empirically measured' },
  'm201': { min: 3200, max: 4300, description: 'Very accurate dynamic - empirically measured' },
  'sm7b': { min: 2500, max: 3800, description: 'Smooth, thick dynamic - empirically measured' },
  'c414': { min: 3550, max: 4800, description: 'Condenser, detailed highs - empirically measured' },
  'roswell': { min: 2450, max: 3300, description: 'Cab mic condenser, ribbon-like rolloff above 3kHz - empirically measured' },
};
