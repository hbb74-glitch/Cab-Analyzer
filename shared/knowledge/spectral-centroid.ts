export const MIC_BASE_CENTROID_RANGES: Record<string, { min: number; max: number; description: string }> = {
  ...
  'r10': { min: 2900, max: 3600, description: 'Ribbon, smooth and warm - empirically measured' },
  'r92': { min: 3300, max: 4000, description: 'Ribbon, similar to R121, slightly darker - empirically measured' },
  'm160': { min: 3200, max: 3700, description: 'Hypercardioid ribbon, tighter and focused - empirically measured' },
  'md421': { min: 3500, max: 4400, description: 'Large diaphragm dynamic, punchy - empirically measured' },
  'md441': { min: 2700, max: 3500, description: 'Dynamic, very accurate (flat mode) - empirically measured' },
  'md441_presence': { min: 3300, max: 4200, description: 'MD441 with presence boost - empirically measured' },
  'm88': { min: 3300, max: 4100, description: 'Warm, great low-end punch - empirically measured' },
  'pr30': { min: 3500, max: 4400, description: 'Large diaphragm dynamic, bright presence peak, detailed highs - empirically measured' },
  'e906': { min: 3700, max: 4200, description: 'Supercardioid (flat mode) - empirically measured' },
