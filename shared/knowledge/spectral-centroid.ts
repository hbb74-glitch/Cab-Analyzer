export const MIC_BASE_CENTROID_RANGES: Record<string, { min: number; max: number; description: string }> = {
  'sm57': { min: 3400, max: 4100, description: 'Classic dynamic, mid-forward, aggressive - empirically measured' },
  'r121': { min: 2750, max: 3700, description: 'Ribbon, smooth highs, big low-mid - empirically measured' },
  'r10': { min: 2750, max: 3750, description: 'Ribbon, smooth and warm - empirically measured' },
  'r92': { min: 3150, max: 4150, description: 'Ribbon, similar to R121, slightly darker - empirically measured' },
  'm160': { min: 3050, max: 3850, description: 'Hypercardioid ribbon, tighter and focused - empirically measured' },
  'md421': { min: 3350, max: 4550, description: 'Large diaphragm dynamic, punchy - empirically measured' },
  'md441': { min: 2550, max: 3650, description: 'Dynamic, very accurate (flat mode) - empirically measured' },
  'md441_presence': { min: 3150, max: 4350, description: 'MD441 with presence boost - empirically measured' },
  'm88': { min: 3150, max: 4250, description: 'Warm, great low-end punch - empirically measured' },
  'pr30': { min: 3350, max: 4550, description: 'Large diaphragm dynamic, bright presence peak, detailed highs - empirically measured' },
  'e906': { min: 3550, max: 4350, description: 'Supercardioid (flat mode) - empirically measured' },
  'e906_presence': { min: 3650, max: 4550, description: 'e906 with presence boost - empirically measured' },
  'm201': { min: 3250, max: 4250, description: 'Very accurate dynamic - empirically measured' },
  'sm7b': { min: 2550, max: 3750, description: 'Smooth, thick dynamic - empirically measured' },
  'c414': { min: 3600, max: 4750, description: 'Condenser, detailed highs - empirically measured' },
  'roswell': { min: 2500, max: 3250, description: 'Cab mic condenser, ribbon-like rolloff above 3kHz - empirically measured' },
};
