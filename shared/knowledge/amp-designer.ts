...
export const FRACTAL_AMP_MODELS: AmpModel[] = [
  ...
  { id: "friedman-be-2010", label: "FRIEDMAN BE 2010", basedOn: "Friedman BE-100", category: "amp", characteristics: "2010 hardware revision of the Friedman BE-100. Very high gain, tight low-end, aggressive midrange. Modern high-gain rock/metal with hot-rodded Marshall DNA. Separate model from the standard BE due to different circuit components." },
  ...
  { id: "friedman-hbe-2010", label: "FRIEDMAN HBE 2010", basedOn: "Friedman HBE", category: "amp", characteristics: "2010 hardware revision of the HBE. Even more saturation and compression than the standard HBE. Different circuit components from the non-2010 version." },
...
export const FRACTAL_DRIVE_MODELS: DriveModel[] = [
  ...
  { id: "compulsion-hp", label: "COMPULSION DIST HP", basedOn: "Fulltone OCD (High Peak mode)", category: "drive", characteristics: "Versatile overdrive/distortion. MOSFET clipping. HP mode has brighter, more cutting response. Wide gain range." },
  { id: "compulsion-lp", label: "COMPULSION DIST LP", basedOn: "Fulltone OCD (Low Peak mode)", category: "drive", characteristics: "Same OCD circuit in LP mode. Warmer, more compressed response with rolled-off highs. Better for rhythm work." },
  ...
  { id: "pi-fuzz", label: "PI FUZZ", basedOn: "Electro-Harmonix Big Muff Pi (current production)", category: "drive", characteristics: "Current production Big Muff. Massive sustaining fuzz. Scooped mids, huge sustain. Wall of fuzz tone." },
  ...
  { id: "pi-fuzz-triangle", label: "PI FUZZ - TRIANGLE", basedOn: "Electro-Harmonix 1971 Big Muff Pi (Triangle knob layout)", category: "drive", characteristics: "Early 1971 Big Muff with triangle knob layout. Smoother, more open than later versions. Less scooped mids. David Gilmour's favorite era." },
  { id: "pi-fuzz-rams-head", label: "PI FUZZ - RAM'S HEAD", basedOn: "Electro-Harmonix 1970s Big Muff Pi (Ram's Head)", category: "drive", characteristics: "Mid-70s Big Muff. Tighter, more aggressive than Triangle. Brighter, more cutting. J Mascis / Dinosaur Jr, Smashing Pumpkins. The classic alt-rock fuzz." },
  { id: "pi-fuzz-russian", label: "PI FUZZ - RUSSIAN", basedOn: "Electro-Harmonix Russian Big Muff Pi (Green/Black)", category: "drive", characteristics: "Russian-made Big Muff variant. Darker, thicker, more bass. Less treble bite. Dan Auerbach / Black Keys. Doomier, sludgier fuzz." },
...
export const KNOWN_MODS: KnownMod[] = [
  ...
  },
  {
    ...
    appliesTo: ["usa-mk-iic-plus", "usa-mk-iic-plus-bright", "usa-mk-iic-plus-deep", "usa-mk-iic-plus-deep-bright", "usa-jp-iic-plus-green", "usa-jp-iic-plus-red", "usa-jp-iic-plus-red-shred", "usa-jp-iic-plus-yellow", "usa-jp-iic-plus-yellow-shred", "usa-mk-iv-lead", "usa-mk-iv-rhythm-1", "usa-mk-v-green", "usa-mk-v-red-mkv", "usa-pre-clean", "usa-pre-lo1-red", "usa-pre-lo2-green", "usa-pre-lo2-yellow", "recto1-orange-modern", "recto1-orange-normal", "recto1-red", "recto2-orange-modern", "recto2-orange-vintage", "recto2-red-modern", "recto2-red-vintage"],
    category: "amp",
  ...
  },
  {
    ...
    appliesTo: ["friedman-be", "friedman-be-2010", "friedman-hbe", "friedman-hbe-2010"],
    category: "amp",
