...
export const shotRecommendationSchema = z.object({
  position: z.string(),
  distance: z.string(),
  blendRatio: z.string().nullable().optional(),
  rationale: z.string(),
  expectedTone: z.string(),
  bestFor: z.string(),
});
...
export const api = {
  ...
  preferences: {
    ...
    superblend: {
      method: 'POST' as const,
      path: '/api/preferences/superblend',
      input: z.object({
        speaker: z.string().min(1, "Specify the speaker type"),
        irCount: z.number().min(3).max(8).default(4),
    ...
    superblendRefine: {
      method: 'POST' as const,
      path: '/api/preferences/superblend/refine',
      input: z.object({
        currentBlend: z.object({
          speaker: z.string(),
        ...
        feedback: z.string().min(1, "Provide feedback"),
        irs: z.array(z.object({
          filename: z.string(),
          subBass: z.number(),
          bass: z.number(),
